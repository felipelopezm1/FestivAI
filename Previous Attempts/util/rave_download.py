...
def download_pretrained_rave(rave_model_dir = "pretrained-models"):
    ...
    pretrained_models = ["sol_ordinario_fast", "isis", "darbouka_onnx"]  # list of available pretrained_models to download in https://acids-ircam.github.io/rave_models_download (you can select less if you want to spend less time on this cell)
